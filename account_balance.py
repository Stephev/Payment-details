...
def sendMail():
    ...
    #receivers = ['pd@xitu.com','chenxing@xitu.com','cj@xitu.com','sxl@xitu.com','dxy@xitu.com']
    receivers=['gaowei@xitu.com','xjj@xitu.com']
    ...
    #邮件正文内容
    message.attach(MIMEText('hi:\n    附件是今日代理余额报表，请查收', 'plain', 'utf-8'))

    # 构造附件1，传送当前目录下的 balance_csv 文件
    att1 = MIMEText(open(balance_csv, 'rb').read(), 'base64', 'utf-8')
    att1["Content-Type"] = 'application/octet-stream'
    # 这里的filename可以任意写，写什么名字，邮件中显示什么名字
    #att1["Content-Disposition"] = 'att1; filename="代理余额.csv"'
    att1.add_header("Content-Disposition", "attachment", filename='代理余额.csv')
    message.attach(att1)
